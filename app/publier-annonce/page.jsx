  ...
  if (accessDenied) {
    return (
      <div className="min-h-screen bg-[#0B1120] flex items-center justify-center px-4">
        <div className="bg-[#1E293B] p-8 rounded-xl text-center max-w-md border border-gray-700">
          <div className="text-5xl mb-4">🚫</div>
          <h2 className="text-xl font-bold text-white mb-2">Accès réservé aux clubs</h2>
          <p className="text-gray-400 mb-6">
            Seuls les comptes de type Club peuvent publier des annonces.
          </p>
          <button
            onClick={() => router.push('/')}
            className="px-6 py-3 bg-[#1D4ED8] text-white rounded-lg hover:bg-blue-700 transition"
          >
            Retour à l’accueil
          </button>
        </div>
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">
            Trouvez le joueur ou l’entraîneur idéal pour votre club
          </p>
        </div>
